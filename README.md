...
We have developed the program for classical planning algorithm using the searching Strategies for planning and executing a sequence of actions succssfully.